...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    private String[] allColumns = {USER_LOGGED_IN_STATUS, JWT_TOKEN, COLUMN_TIMESTAMP, COLUMN_ID};

    private static final String CREATE_DB = "CREATE TABLE " + TABLE_NAME + "(" + USER_LOGGED_IN_STATUS + " TEXT, " + JWT_TOKEN + " TEXT," + COLUMN_TIMESTAMP + " DATETIME DEFAULT CURRENT_TIMESTAMP, " + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT" + ")";
